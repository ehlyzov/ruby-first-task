...
- Создать функцию, принимающую на вход сайта, которая возвращает хеш с подсайтами. Функция вызывается рекурсивно. Поиск подсайтов выполняется регулярным выражением.
